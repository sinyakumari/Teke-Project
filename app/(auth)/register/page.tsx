  ...
  return (
    <div className="min-h-screen bg-[#f2f2f7] lg:bg-[#1a1f2e] overflow-x-hidden">
      ...
      <div className="hidden lg:flex h-screen overflow-hidden">
        ...
        <div className="flex-1 h-full bg-white flex items-center justify-center px-4 rounded-r-[40px] relative z-20 animate-in fade-in slide-in-from-left duration-700">
          <div className="w-full max-w-md p-10">
            {/* Back Button */}
            <button
              onClick={() => router.back()}
              className="w-10 h-10 flex items-center justify-center mb-6 hover:bg-gray-100 rounded-2xl transition-all active:scale-90"
            >
            ...
            <h1 className="text-3xl font-bold text-[#1a1f2e] mb-1 tracking-tight">Create account ✨</h1>
        ...
        <div className="flex lg:w-[55%] h-full flex-col justify-between p-12 bg-[#1a1f2e] relative overflow-hidden text-right animate-in fade-in slide-in-from-right duration-700">
      ...
      <div className="lg:hidden min-h-screen flex flex-col bg-white font-body text-[#1a1c1f] antialiased relative">
        ...
        <header className="absolute top-0 left-0 w-full px-8 py-8 z-50 flex justify-between items-center">
          <button
            onClick={() => router.back()}
            className="bg-white/10 backdrop-blur-md w-10 h-10 rounded-xl flex items-center justify-center border border-white/20 text-white"
          >
        ...
        <main className="flex-grow">
          ...
          <section className="hero-mesh relative overflow-hidden pt-28 pb-10 px-8 rounded-b-[3.5rem] shadow-2xl">
            <div className="technical-pattern absolute inset-0 opacity-40"></div>
            <div className="relative z-10 max-w-md mx-auto">
              <h2 className="font-headline text-[2.5rem] font-extrabold text-white leading-[0.9] tracking-[-0.04em] mb-4">
                One platform.<br/>Infinite Potential.
              </h2>
              <p className="text-white/60 font-body text-xs leading-relaxed mb-0">
                Start your high-performance journey today with our all-in-one manager.
              </p>
            </div>
          </section>

          {/* Form Section */}
          <div className="max-w-md mx-auto px-6 -mt-8 mb-12 relative z-20">
            <div className="bg-white rounded-[2.5rem] p-8 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.12)] space-y-6">
              
              {/* Form Header */}
              <div>
                <h3 className="text-2xl font-extrabold text-[#030714] font-headline tracking-tight mb-1">Create account ✨</h3>
                <p className="text-[#46464c]/60 text-xs font-medium">Start your high-performance journey today</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="group">
                  <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#46464c]/60 mb-2 ml-1">Full name</label>
                  <input 
                    className="w-full h-14 px-6 glass-input rounded-2xl focus:ring-0 focus:outline-none text-[#1a1c1f] font-medium" 
                    placeholder="Rahul Sharma" 
                    type="text"
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="group">
                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#46464c]/60 mb-2 ml-1">Password</label>
                    <input 
                      className="w-full h-14 px-4 glass-input rounded-2xl focus:ring-0 focus:outline-none text-[#1a1c1f] font-medium" 
                      placeholder="········" 
                      type="password"
                      value={password}
                      onChange={(e) => setPassword(e.target.value)}
                  ...
                  <div className="group">
                    <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#46464c]/60 mb-2 ml-1">Confirm</label>
                    <input 
                      className="w-full h-14 px-4 glass-input rounded-2xl focus:ring-0 focus:outline-none text-[#1a1c1f] font-medium" 
                      placeholder="········" 
                      type="password"
                ...
                {/* Terms */}
                <div className="flex items-start gap-3 py-2 cursor-pointer" onClick={() => setAgreedToTerms(!agreedToTerms)}>
                  <div className={`w-5 h-5 rounded-md border-2 flex-shrink-0 mt-0.5 flex items-center justify-center transition-all ${
                    agreedToTerms ? 'bg-[#030714] border-[#030714]' : 'border-gray-200 bg-white'
                  }`}>
                    {agreedToTerms && (
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M20 6L9 17L4 12" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    )}
                  </div>
                  <p className="text-[10px] text-gray-400 leading-tight font-bold uppercase tracking-wider">
                    Join TEKE Terms of Service and Privacy Policy. I understand my data is secure.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <button 
                  onClick={handleRegister}
                  disabled={!isFormValid || loading}
                  className={`w-full h-16 font-headline font-bold text-lg rounded-2xl shadow-[0_20px_40px_-12px_rgba(3,7,20,0.35)] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 ${
                    isFormValid && !loading ? 'bg-[#030714] text-white shadow-[#030714]/30' : 'bg-gray-100 text-gray-400 shadow-none'
                  }`}
                >
                  {loading ? (
                    <div className="flex items-center justify-center gap-3">
                ...
                <div className="relative py-2 flex items-center">
                  ...
                  <span className="flex-shrink mx-4 text-[10px] font-bold text-gray-300 uppercase tracking-[0.3em]">or join with</span>
                  <div className="flex-grow border-t border-gray-100"></div>
                </div>
              ...
              <div className="text-center pt-2">
                <p className="text-[#46464c]/60 text-xs font-medium">
                  Already have an account? 
                  <Link href="/login" className="text-[#030714] font-extrabold underline underline-offset-8 ml-2 hover:text-[#030714]/70 transition-colors">
                    Sign in now
                  </Link>
                </p>
              </div>

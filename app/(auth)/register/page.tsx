    ...
    <div className="min-h-screen bg-[#f2f2f7] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8">
        ...
        <button 
          ...
          disabled={loading}
          className="w-full bg-white border-2 border-gray-200 rounded-2xl py-3.5 font-semibold text-sm text-[#1a1f2e] flex items-center justify-center gap-3 mb-6 hover:bg-gray-50 transition-colors disabled:opacity-70"
        >
          {loading ? (

        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-4 gap-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              {/* Task Extractor - icon only on mobile */}
              <button
                onClick={() => router.push('/tasks/extract')}
                className="bg-white border border-slate-200 text-[#1a1f2e] p-2 sm:px-4 sm:py-2 rounded-xl font-black flex items-center gap-2 hover:bg-slate-50 transition-all min-h-[40px]"
                title="Task Extractor"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>
                </svg>
                <span className="hidden sm:inline text-sm">Task Extractor</span>
              </button>

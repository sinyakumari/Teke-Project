          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="bg-white border border-slate-200 text-[#1a1f2e] px-4 py-2 rounded-xl text-sm font-black flex items-center gap-2 hover:bg-slate-50 transition-all"
              >

      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide">
        <div className="max-w-lg mx-auto">
          ...
          <div className="px-4 py-4 pb-10">
            ...
            {/* Upload PDF Card */}
            <div className="bg-gradient-to-b from-gray-50 to-white border-2 border-dashed border-gray-200 rounded-2xl p-6 mb-3 flex flex-col items-center text-center">
              <div className="text-2xl mb-2">✨</div>
              <p className="font-bold text-[#1a1f2e] text-sm mb-1">
                Upload PDF & Extract Tasks
              </p>
              <p className="text-gray-400 text-xs mb-4">
                ...
                in your PDF and they will be auto-created
              </p>
              <label className="w-full bg-[#1a1f2e] text-white rounded-xl py-3 font-semibold text-sm flex items-center justify-center gap-2 cursor-pointer hover:bg-[#2d3548] transition-colors">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      alert(
                        `PDF "${file.name}" selected! PDF task extraction coming soon.`
                      )
                    }
                  }}
                />
            ...
            {/* Attach Other Files */}
            <div className="mb-6">
              <label className="w-full bg-white border-2 border-gray-200 text-[#1a1f2e] rounded-2xl py-3 font-semibold text-sm flex items-center justify-center gap-2 cursor-pointer hover:bg-gray-50 transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      alert(
                        `File "${file.name}" selected! File attachment coming soon.`
                      )
                    }
                  }}
                />

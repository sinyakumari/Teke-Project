    ...
    <div className="fixed top-0 bottom-0 md:right-[500px] right-0 z-[120] pointer-events-none h-full">
      ...
      >
        ...
        <div className="p-3 bg-white border-t border-slate-100 flex items-center justify-between gap-2 absolute bottom-0 left-0 right-0 shadow-sm">
          <button
            onClick={onClose}
            className="px-4 py-2 border border-slate-200 text-[#1a1f2e] text-[8px] font-bold uppercase tracking-widest hover:bg-slate-50 transition-all"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="flex-1 py-2 bg-[#1a1f2e] text-white text-[8px] font-bold uppercase tracking-widest shadow-lg flex items-center justify-center gap-2 disabled:opacity-50"
          >
